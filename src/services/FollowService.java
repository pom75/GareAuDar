...
public class FollowService {
	...
	public static boolean addFollow(String user1,String user2, String key){
		if(user1.isEmpty() || user1.equals("") || user2.isEmpty() || user2.equals("") || !UserBD.myKey(user1, key)){
			return false;
		}else{
	...
	public static boolean removeFollow(String key, String user1, String user2) {
		if(!UserBD.myKey(user1, key) || user1.isEmpty() || user1.equals("") || user2.isEmpty() || user2.equals("")){
			return false;
		}else{
